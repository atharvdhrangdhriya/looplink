...
const UserProfile = () => {
  ...
  useEffect(()=>{
    ...
    if (storedUser) {
      ...
      if (userData.image) {
        // Assuming the image is stored as a file object in userData
        setProfileImage(URL.createObjectURL(userData.image)); // Create a URL for the file object
                ...
                <div className="top-menu-right">
                  ...
                  <p className="m-0">
                    ...
                    <span
                      data-toggle="popover"
                      title=""
                      data-content="Analytics on views"
                    >
                      Loop
                    </span>
                  </p>
          ...
          <div className="row">
            <div className="col-xs-12">
              ...
              <h2 className="text-center">
                <strong>Felix Stephenson</strong>
              </h2>
              <p style={{ wordWrap: "break-word" }} />
              <div className="text-center">
                {/* <a href="https://looplink.me/logout" class="btn btn-custom-black ">Direct Off</a> */}
                {/* <a href="javascript:;" class="btn btn-custom-black direct_on_off" data-direct-on-off="1">Quick Link On</a> */}
